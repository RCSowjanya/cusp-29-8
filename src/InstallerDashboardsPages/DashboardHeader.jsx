...
const DashboardHeader = ({ title, showBackButton, backLink }) => {
    ...
    <div className="m-[2%]">
      ...
      <div className="flex items-center justify-between mb-4 max-[700px]:flex-col max-[1100px]:space-y-8 max-[1100px]:justify-center">
        <div className="flex-1 flex items-center">
          ...
          {showBackButton && (
            <a href={backLink} className="mr-4 text-[#4348BD] flex gap-1">
              <FaArrowLeftLong size={24} className="" />
              <p className="text-[12px] font-[600] mt-1">Back</p>
            </a>
          )}
