...
import logo from "../Images/cusp-logo.webp"; // Import your logo image here

const sidebarItems = [
  { name: "dashboard", label: "Dashboard", icon: MdDashboard },
  { name: "orders", label: "Orders", icon: MdShoppingCart },
  { name: "quotations", label: "Quotations", icon: MdInsertDriveFile },
  { name: "proposals", label: "Proposals", icon: MdInsertDriveFile },
  { name: "profile", label: "Profile", icon: MdInsertDriveFile },
  { name: "quotations3", label: "quotations3", icon: MdInsertDriveFile },
  { name: "quotations4", label: "quotations4", icon: MdInsertDriveFile },
];

const InSidebar = ({ isActiveItem, setIsActiveItem }) => {
