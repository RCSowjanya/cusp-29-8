...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: "Contribute to our Blog", href: "/contribute" },
  ...
  return (
    <nav className="bg-[#4348BD] shadow-2xl nav z-[9999]">
      <div className="px-6">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div>
            <a href="/" className="w-full">
              <img src={logo} className="" alt="cusp-logo" />
            </a>
          </div>
          ...
          <div className="flex gap-3 max-[1000px]:hidden">
            <a href="/joinus">
              <button className="py-2 px-4 border-2 border-[#FFAC0B] font-[700px] text-[#FFAC0B] rounded-md hover:bg-yellow-500 hover:text-black transition duration-300 flex items-center">
                Join Us
        ...
        <ul className="">
          ...
          <li className="mt-5">
            <a href="/joinus" onClick={closeMenu}>
              <button className="py-2 mb-5 px-4 border-2 border-yellow-500 font-bold text-yellow-500 rounded-lg hover:bg-yellow-500 hover:text-black transition duration-300 flex items-center">
                Join Us
                <FaArrowRight className="ml-2" />
              </button>
            </a>
          ...
          <li>
            <a href="/getquote" onClick={closeMenu}>
              <button className="py-2 px-4 bg-yellow-500 text-black rounded-lg font-bold border-2 border-yellow-500 hover:bg-transparent hover:border-yellow-500 hover:text-yellow-500 transition duration-300 flex items-center">
                Get a Quote <FaArrowRight className="ml-2" />
              </button>
            </a>
          </li>
